        ...
        <div class="sidebar-content">
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item">
                        <a href="<?= base_url('pessoa'); ?>"><i class="fas fa-file-invoice-dollar"></i><span style="color: #f2f3ef; font-family: 'Roboto', sans-serif; font-size: 14px;">Pessoas</span> <span class="badge badge-success"></span></a>
                    </div>
                    <div class="nav-item">
