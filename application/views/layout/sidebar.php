            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-user"></i><span style="color: #f2f3ef; font-family: 'Roboto', sans-serif; font-size: 14px;">Pessoas</span></a>
                        <div class="submenu-content">
                            <a href="<?= base_url('pessoa'); ?>"><i class="ik ik-user"></i><span style="color: #f2f3ef; font-family: 'Roboto', sans-serif; font-size: 14px;">Pessoas</span></a>
                            <a href="<?= base_url('voluntario'); ?>"><i class="ik ik-user"></i><span style="color: #f2f3ef; font-family: 'Roboto', sans-serif; font-size: 14px;">Voluntários</span> <span class="badge badge-success"></span></a>
                        </div>
                    </div>
                    <div class="nav-item">
